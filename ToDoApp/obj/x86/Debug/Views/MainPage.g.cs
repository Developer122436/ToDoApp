#pragma checksum "C:\Users\Dima_Spektor12\OneDrive\Desktop\Programming\Home Tests\ToDoApp\ToDoApp\Views\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "0C4215891ED96C5F482340C54053D2FF"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace ToDoApp.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::ToDoApp.Models.ToDoTask dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::ToDoApp.Models.ToDoTask) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::ToDoApp.Models.ToDoTask)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::ToDoApp.Models.ToDoTask obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::ToDoApp.Views.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 31 && columnNumber == 76)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::ToDoApp.Views.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::ToDoApp.Views.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel(global::ToDoApp.ViewModels.MainPageViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_ToDoTasks(obj.ToDoTasks, phase);
                    }
                }
            }
            private void Update_ViewModel_ToDoTasks(global::System.Collections.ObjectModel.ObservableCollection<global::ToDoApp.Models.ToDoTask> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 2: // Views\MainPage.xaml line 31
                {
                    this.TasksLV = (global::Windows.UI.Xaml.Controls.ListView)(target);
                }
                break;
            case 7: // Views\MainPage.xaml line 42
                ...
                break;
            case 8: // Views\MainPage.xaml line 24
                {
                    global::Windows.UI.Xaml.Controls.AppBarButton element8 = (global::Windows.UI.Xaml.Controls.AppBarButton)(target);
                    ((global::Windows.UI.Xaml.Controls.AppBarButton)element8).Click += this.AddButton_Click;
                }
                break;
